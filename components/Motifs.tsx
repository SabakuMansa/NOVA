...
export function MotifPlate({ color, ink }: MotifProps) {
  return (
    ...
    >
      ...
      <path
        d="M100 52c-8 0-12 8-12 18s5 16 12 16 12-6 12-16-4-18-12-18Z"
        fill={ink}
        opacity="0.22"
      />
      <rect
...
export function MotifBag({ color, ink }: MotifProps) {
  return (
    ...
    >
      <rect width="200" height="140" fill={ink} opacity="0.04" />
      <path
        d="M64 52h72l8 62a6 6 0 0 1-6 7H62a6 6 0 0 1-6-7l8-62Z"
        fill={color}
        opacity="0.9"
      />
      <path
        d="M82 58V44a18 18 0 0 1 36 0v14"
        stroke={ink}
        strokeWidth="3"
        opacity="0.5"
        strokeLinecap="round"
...
export function MotifTools({ color, ink }: MotifProps) {
  return (
    ...
    >
      <rect width="200" height="140" fill={ink} opacity="0.04" />
      <path
        d="M70 44l30 30-14 14-30-30a10 10 0 0 1 14-14Z"
        fill={color}
        opacity="0.9"
      />
      <rect
