    ...
    <section className="mx-auto max-w-content px-5 py-16 md:px-8 md:py-24">
      <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16">
        <div>
          ...
          <h1 className="mt-6 font-pixel text-2xl leading-relaxed tracking-tight text-arcade-cream sm:text-3xl">
            {accueil.title}
          </h1>
      ...
      <div className="mt-16 flex flex-wrap items-center gap-4 rounded-xl border border-arcade-border bg-arcade-card p-5 sm:p-6">
        ...
        <div>
          ...
          <p className="mt-1.5 font-terminal text-base text-arcade-tan">
